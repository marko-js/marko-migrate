...
TagHandlers.prototype = {
    ...
    renderer: function(value) {
        ...
        try {
            path = resolveFrom(dirname, value);
    ...
    bodyProperty: function(value) {
        logging.getLogger().warn(`The "body-property" is no longer supported for tags. You will need to fix "${relativePath(this.path)}". See: [TBD]`);
        var tag = this.tag;
